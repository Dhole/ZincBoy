...
mod tests {
    ...
    fn op_thumb_asm() {
        ...
        let insts_bin_asm = vec![
            ...
            //        Op D S Rs  Rd
            (0b010001_00_1_1_001_010, "add r10, r9", "HiRegBx (5)"),
            (0b010001_01_1_1_001_010, "cmp r10, r9", "HiRegBx (5)"),
            (0b010001_10_1_1_001_010, "mov r10, r9", "HiRegBx (5)"),
            (0b010001_11_0_0_001_010, "bx r1      ", "HiRegBx (5)"),
            (0b010001_11_0_1_001_010, "bx r9      ", "HiRegBx (5)"),
            (0b010001_11_1_0_001_010, "invalid    ", "HiRegBx (5)"),
            (0b010001_11_1_1_001_010, "invalid    ", "HiRegBx (5)"),
            (0b010001_00_0_1_001_010, "add r2, r9 ", "HiRegBx (5)"),
            (0b010001_01_1_0_001_010, "cmp r10, r1", "HiRegBx (5)"),
            (0b010001_10_0_0_001_010, "invalid    ", "HiRegBx (5)"),
            // //       Rd  Word
            // (0b01001_000_00000000, "", "LdrPc (6)"),
            // //      Op   Ro  Rb  Rd
            // (0b0101_00_0_000_000_000, "", "LdrStr (7)"),
            // //      Op   Ro  Rb  Rd
            // (0b0101_00_1_000_000_000, "", "XHSbSh (8)"),
            // //     Op Off.  Rb  Rd
            // (0b011_00_00000_000_000, "", "XB (9)"),
            // //      O Off.  Rb  Rd
            // (0b1000_0_00000_000_000, "", "XH (10)"),
            // //      O Rd  Word
            // (0b1001_0_000_00000000, "", "XSp (11)"),
            // //      O Rd  Word
            // (0b1010_0_000_00000000, "", "AddPcSp (12)"),
            // //          S Word
            // (0b10110000_0_0000000, "", "AddSpNn (13)"),
            // //      O    R Rlist
            // (0b1011_0_10_0_00000000, "", "PushPop (14)"),
            // //      O Rb  Rlist
            // (0b1100_0_000__00000000, "", "StmLdm (15)"),
            // // _16_|_1___1___0___1_|_____Cond______|_________Signed_Offset_________|B{cond}
            // //      Cond SigOff.
            // (0b1101_0000_00000000, "", "BranchCond (16)"),
            // //          UserData
            // (0b11011111_00000000, "", "Swi (17)"),
            // //       Offset
            // (0b11100_00000000000, "", "Branch (18)"),
            // // _19_|_1___1___1___1_|_H_|______________Offset_Low/High______________|BL,BLX
            // //      H OffsetLoHi
            // (0b1111_0_00000000000, "", "BranchLink (19)"),
        ];
        println!("# Radare disasm");
        for (inst_bin, _, desc) in &insts_bin_asm {
            println!(
